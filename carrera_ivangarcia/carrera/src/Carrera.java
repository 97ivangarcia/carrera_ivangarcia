...
public class Carrera extends JPanel {
    ...
    public Carrera(int distanciaCircuito) {
        ...
        // el background
        try {
            fondo = ImageIO.read(new File("carrera/imagenes/carretera.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            coche1 = ImageIO.read(new File("carrera/imagenes/mario.png"));
            coche2 = ImageIO.read(new File("carrera/imagenes/toadette.png"));
            coche3 = ImageIO.read(new File("carrera/imagenes/bolt.png"));
            coche4 = ImageIO.read(new File("carrera/imagenes/waluigi.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void anunciarGanador(String ganador) {
        JOptionPane.showMessageDialog(this, ganador + " ha llegado a la meta");
    ...
    public static void main(String[] args) {
        // Crear ventana
        JFrame ventana = new JFrame("Mario Kart Ilerna!");
